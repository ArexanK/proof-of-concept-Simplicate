...
import { Failure, fold, Initialized, Pending, Success } from '@abraham/remotedata';
import { html, property, Seed, svg } from '@nutmeg/seed';
import { Api } from './api';
import { FailureView } from './failure.view';
import { PendingView } from './pending.view';
import { DEFAULT_INSTALL_SOURCE, Pkg } from './pkg';
...
export class NodePackage extends Seed {
    ...
    get view() {
        return fold(() => this.initializedHandler(), () => this.pendingHandler(), (error) => this.errorHandler(error), (data) => this.successHandler(data));
    }
    async fetchPackage() {
        if (this.name) {
...
], NodePackage.prototype, "global", void 0);
__decorate([
    property({ type: String }),
    __metadata("design:type", String)
], NodePackage.prototype, "name", void 0);
window.customElements.define('node-package', NodePackage);
//# sourceMappingURL=node-package.js.map